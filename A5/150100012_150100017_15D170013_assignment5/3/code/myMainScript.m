...
% Part b: Peaks found at (119,124) and (139,134) in the log magnitude of
% Fourier transform corresponding to the interfering frequencies
% Part c: Implementation of Ideal Notch Filter and removal of interfering frequencies
for i = -3:3
	for j = -3:3
