...
% % Testing the svd implementation on the att_faces
...
% Testing the svd implementation on the Yale Dataset
...
% recog_rates for all the eigen vectors starting from 1
